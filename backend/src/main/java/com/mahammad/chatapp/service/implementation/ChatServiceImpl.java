...
import com.mahammad.chatapp.repository.ChatRepository;
...
public class ChatServiceImpl implements ChatService {
    ...
    @Override
    public Chat findChatById(UUID id) throws ChatException {    //findChatById: “Give me the chat with this exact ID—or tell me it doesn’t exist.”
    ...
    @Override
    public List<Chat> findAllByUserId(UUID userId) throws UserException {  // findAllByUserId: “First, make sure the user exists.
        // Then get every chat they’re in, sort them so the most recently active appear first (and empty chats last), and hand you the sorted list.”
